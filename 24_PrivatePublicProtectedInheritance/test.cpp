...
void test_B1(void){
    ...
    pB1->f();
    pB1->g1();
    (dynamic_cast<D*>(pB1))->B1::f(); 
    (dynamic_cast<D*>(pB1))->g2(); 
    (dynamic_cast<D*>(pB1))->B2::f(); 
    (dynamic_cast<D*>(pB1))->g3(); 
    (dynamic_cast<D*>(pB1))->B3::f(); 
    (dynamic_cast<D*>(pB1))->g4(); 
    (dynamic_cast<D*>(pB1))->B4::f(); 
    (dynamic_cast<D*>(pB1))->g11(); 
    (dynamic_cast<D*>(pB1))->B11::f(); 
    (dynamic_cast<D*>(pB1))->g22(); 
    (dynamic_cast<D*>(pB1))->B22::f(); 
